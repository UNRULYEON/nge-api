...
const episodes: [Episode, ...Episode[]] = [
  {
    ...
    show_id: uuids.SHOW_IDS.nge,
  },
  {
    id: uuids.EPISODE_IDS.ep2,
    episode_number: 2,
    title: "The Beast",
